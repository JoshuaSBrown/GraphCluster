...
namespace ugly {
  ...
  void GraphVisitorGeneric::GraphVisitorGeneric(){
    ...
    allowed_conversions_[constants::EdgeType::undirected].push_back(constants::EdgeType::edge);
    allowed_conversions_[constants::EdgeType::directed].push_back(constants::EdgeType::edge);
    allowed_conversions_[constants::EdgeType::directed_weighted].push_back(constants::EdgeType::edge);
    allowed_conversions_[constants::EdgeType::weighted].push_back(constants::EdgeType::edge);
  }
  ...
  void GraphVisitorGeneric::addEdge_(weak_ptr<Edge>){
    return;
  }
